...
type: note
permalink: ai-for-interviewer/docs/modules/m06-simulated-interview-and-context/module-api-design
---

# M06 模拟面试、上下文与导出 - API 设计
...
- POST /api/v1/interviews/{interviewId}/export
