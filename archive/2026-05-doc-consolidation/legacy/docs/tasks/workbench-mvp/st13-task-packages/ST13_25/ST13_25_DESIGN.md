...
type: note
permalink: ai-for-interviewer/docs/tasks/workbench-mvp/st13-task-packages/st13-25/st13-25-design-1
---
...
- 明确唯一输入维护、OQ / DD / backlog-roadmap、State Write 历史、archive 历史治理和收口报告结构。
...
- `docs/design/workbench-mvp/` 当前设计输入和 W13-E5 / E6 / E7 文档。
...
- `docs/design/workbench-mvp/` 当前设计输入继续作为产品和对象边界真值。
...
- 后续 Superpowers 计划更新必须引用当前输入、本轮双文档路径和 W13-E9 contract_refined 结论。
- 不得用历史 原型替代 W13 工作台 MVP。
...
- 只更新当前输入或对应计划，不把 archive 历史文档改写为当前输入。
