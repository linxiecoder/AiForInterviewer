---
title: 2026-04-25-workbench-mvp-backlog-roadmap-history-2026-05-01
type: note
permalink: ai-for-interviewer/archive/planning/workbench-mvp/2026-04-25-workbench-mvp-backlog-roadmap-history-2026-05-01
status: archived
archived_from: docs/planning/workbench-mvp/2026-04-25-workbench-mvp-backlog-roadmap.md
...
| BR-STATE-002 | 创建 preview YAML 验证 W13 新任务结构 | 状态层后续事项 | done | P0 | W13-E2 / OQ-093 | W13-E3 / Preview YAML | 用户已确认方案 B | W13-E3 | 2026-04-25 | 已创建 `W13-E3 Preview YAML 过程记录` 并通过预检。 |
| BR-STATE-003 | 设计后续 State Write 窗口 | 状态层后续事项 | done | P0 | W13-E3 Preview YAML | W13-E4-A | 已形成 C-Phased 分阶段计划 | W13-E4-A | 2026-04-25 | 已新增 `W13-E4-A State Write 分阶段计划`。 |
...
| BR-STATE-005 | 处理 archive-candidate 的状态层解除引用条件 | 状态层后续事项 | open | P1 | W13-StateArchive / W13-E2 / W13-E4-A | 后续 Archive Cleanup | 依赖阶段 3 | W13-E4+ | 2026-04-25 | 解除 `DOC_STATE.yaml`、`TASK_INDEX.md`、`MODULE_INDEX.md` 引用前不得移动历史任务文档。 |
...
| BR-STATE-009 | 创建 Stage3 Preview YAML | 状态层后续事项 | done | P0 | W13-E4-D / OQ-097 | W13-E4-E / Stage3 Preview | 用户已确认 `OQ-097=B` | W13-E4-E | 2026-04-26 | 已创建 `W13-E4-E Stage3 Preview YAML`；preview `validate/evaluate` 全绿，正式 `DOC_STATE.yaml` 未修改。 |
...
| BR-REMAP-006 | ST13 readiness audit | Task Remap 后续事项 | done | P0 | W13-E5 | W13-E5 | 已完成 `ST13_01~ST13_25` 前置审计，不放行 implementation-ready | W13-E5 | 2026-04-26 | 新增 `W13-E5 readiness audit 过程记录`；`OQ-101~OQ-110` 已由 W13-E6 确认。 |
| BR-REMAP-007 | 第一批 ST13 任务包准备 | Task Remap 后续事项 | done | P0 | W13-E5 | W13-E6 | 用户已确认 `OQ-101~OQ-110`，已生成第一批任务包草案 | W13-E6 | 2026-04-26 | 新增 `W13-E6 第一批任务包草案`；不得生成 implementation packet。 |
| BR-REMAP-008 | 第一批 ST13 正式双文档准备 | Task Remap 后续事项 | done | P0 | W13-E6 | W13-E7 | 已形成双文档路径和模板准备方案 | W13-E7 | 2026-04-26 | 新增 `W13-E7 双文档准备方案`；状态只到 `double_doc_path_planned`，仍不得实现。 |
...
| BR-REMAP-014 | 第一批 ST13 candidate State Update Preview | Task Remap 后续事项 | done | P0 | W13-E12 | W13-E13 | 用户已确认 `OQ-118=B`、`OQ-119=A`、`OQ-120=B` | W13-E13 | 2026-04-26 | 已创建 `W13-E13 candidate State Update Preview`；Preview 验证失败，正式 `DOC_STATE.yaml` 未修改。 |
...
| ID | 标题 | 类别 | 状态 | 优先级 | 来源 | 负责人或处理窗口 | 阻断关系 | 目标解决窗口 | 最近更新时间 | 备注 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BR-ARCH-001 | `STxx_*` 历史任务目录处理 | 历史材料后续事项 | open | P1 | W13-StateArchive / W13-E2 | 历史材料清理窗口 | 依赖状态层解除引用 | W13-E3+ | 2026-04-25 | 用户已确认后续 superseded，但目录处理仍需单独确认和状态层前置。 |
| BR-ARCH-002 | 历史材料链接复核 | 历史材料后续事项 | backlog | P2 | W13-StateArchive | 历史材料清理窗口 | 依赖 BR-ARCH-001 | 后续归档窗口 | 2026-04-25 | 后续必须复核根索引、模块索引和历史引用说明。 |
| BR-ARCH-003 | 模块历史文档清理 | 历史材料后续事项 | backlog | P2 | W13-GOV-MergeArchive | 模块同步窗口 | 依赖模块窗口 | 后续模块同步 | 2026-04-25 | 只清理当前事实源误导，不删除仍有追溯价值的历史记录。 |
| BR-ARCH-004 | 历史路径引用残留复查 | 历史材料后续事项 | backlog | P2 | W13-StateArchive | Review 窗口 | 依赖归档动作 | 后续归档窗口 | 2026-04-25 | 重点复查历史设计稿、历史实现计划、历史 ST 和历史引用说明。 |
