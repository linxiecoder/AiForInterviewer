...
| OQ-008 | 匹配分析与评估规则是否需要版本化 | historical | `MODULE_REQUIREMENTS.md`、`MODULE_TASK_INDEX.md`、`ST04_02`、`ST04_03` | 已由 Workbench MVP 正式设计事实源和 `FC-17` / `DD-009` 覆盖：匹配分析与评估采用规则版本化 + 共享核心评估框架 + 规则推荐优先 | 否 | 已在本模块文档改为历史引用 |
