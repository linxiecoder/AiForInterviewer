...
| Rollback | PR3 rollback disable facade wiring and restore legacy direct path；PR4 rollback disable runtime feature flag / fake runtime；checkpoint refs 不作为业务事实，不用于恢复正式结果 | rollback runbook + boundary tests |
