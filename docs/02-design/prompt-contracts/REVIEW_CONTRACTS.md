...
Review contracts 只负责生成模拟面试复盘、结构化真实面试输入、生成真实面试复盘，以及提炼题级复盘项。Review contracts 不负责继续提问、重新生成压力面报告、重新评分 Pressure session、正式创建 Weakness、正式创建 Asset、正式创建 TrainingRecommendation、关闭复盘切分规则 UNKNOWN、关闭真实面试输入结构化规则 UNKNOWN、关闭题级复盘项合并规则 UNKNOWN、关闭薄弱项合并算法 UNKNOWN、关闭资产归档策略 UNKNOWN 或关闭训练优先级 UNKNOWN。
...
- 不得关闭复盘切分规则、真实面试输入结构化规则、题级复盘项合并、薄弱项合并算法、资产归档策略或训练优先级 UNKNOWN。
...
- Open Questions: 复盘切分规则、题级复盘项合并规则、薄弱项合并算法、资产归档策略和训练优先级仍待后续 contract / API / UX 收敛，不在本 contract 关闭。
...
- Open Questions: 真实面试输入结构化规则、字段合并规则、用户确认 UI 和复盘切分规则仍待后续 contract / API / UX 收敛，不在本 contract 关闭。
...
- Open Questions: 复盘切分规则、题级复盘项合并、薄弱项合并算法、资产归档策略和训练优先级仍待后续 contract / API / UX 收敛，不在本 contract 关闭。
...
- Open Questions: 题级复盘项合并规则、薄弱项合并算法、资产归档策略、训练优先级和跨复盘聚合规则仍待后续 contract / API / UX 收敛，不在本 contract 关闭。
...
- Review contracts 不得关闭复盘切分规则、真实面试输入结构化规则、题级复盘项合并规则、薄弱项合并算法、资产归档策略或训练优先级 UNKNOWN。
