...
- `docs/03-implementation/DELIVERY_PLAN.md` §1、§3
- `docs/03-implementation/BACKLOG.md` §1
Affected Phase:
- F5 / F6 / F7
Affected Handoff:
...
- `docs/03-implementation/BACKLOG.md`：将仍需后续承接的 Deferred 项登记为 AIFI-* 任务或明确 Accepted_Risk / 不阻断理由。
