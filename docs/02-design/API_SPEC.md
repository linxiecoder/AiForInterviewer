...
| validation_errors | `AiTaskResultResponse.validation_errors[]`, task result validation fields | 仅返回用户安全错误摘要；不得包含 raw provider payload、Prompt、completion、完整简历或完整 JD |
...
| data.validation_errors[] | 否 | string[] \| null | 用户安全摘要 | 校验错误摘要；不得包含 raw provider payload、Prompt、completion、完整简历或完整 JD | loggable |
...
| validation_errors[] | 否 | string[] \| null | 用户安全摘要 | 校验错误摘要；不得包含 raw provider payload、Prompt、completion、完整简历或完整 JD | loggable |
