...
2. 继续迭代 `API_SPEC.md`，细化 Candidate / Confirmation、Asset / Training handoff、status query、retry、idempotency、async job 等 API 契约。
...
- `API_SPEC.md` 已作为 F4 API contract 草案存在，当前仍不冻结完整 endpoint、path、method 或完整 request / response schema。
