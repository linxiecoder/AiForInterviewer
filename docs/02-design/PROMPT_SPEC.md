...
### 12.9 Polish 6B 公共边界与 Output Schema
...
### 12.10 `P-POLISH-009` Next Round Suggestion
...
- Output Schema:
  - 公共字段：必须完整包含 §12.9 的 Polish 6B 公共 Output Schema。
...
### 12.11 `P-POLISH-010` Asset Candidate
...
### 12.12 `P-POLISH-011` Weakness Candidate
