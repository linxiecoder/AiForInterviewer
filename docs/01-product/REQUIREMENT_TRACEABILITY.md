...
### 5.8 Step 5 / AIFI-BE-015 Implementation Authorization 状态登记

本节登记 `.omo/plans/plan.md` Step 5 的 implementation-ready 授权入口。该状态只授权后续重新执行 Step5 scope lock；本节本身不实现 Step5，不修改 `apps/**`、`tests/**`、FE、migration、配置或依赖。
