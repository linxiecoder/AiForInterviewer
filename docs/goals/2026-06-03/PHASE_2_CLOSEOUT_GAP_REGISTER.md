...
| --- | --- | --- | --- | --- |
| P2-CLOSEOUT-SRC-001 | `deferred` | `GITHUB_CODE` | W6 checked all root-level Project source pack paths named by `phase2_goal.md`; all are missing and no alternate same-name path was found. | Owner must provide or restore the Project source pack path before matrix / risk / acceptance / roadmap backfill can be written. |
