...
| P3-ENTRY-GAP-DDD-004-001 | Domain policy extraction overall | `partial_p3_w3` | Source support, question grounding, follow-up coverage, and P3-W3 feedback review policies live under `app.domain.polish.policies`; P3-W4 next-action and P3-W5 bridge hardening remain open. | Continue with P3-W4 / P3-W5 after controller approval; do not close Phase 3 yet. |
...
| P3-ENTRY-GAP-TEST-001 | Domain policy tests | `partial_p3_w3_added_feedback_review_tests` | P3-W2 question policy tests and P3-W3 feedback review policy tests exist under `tests/domain/polish/`; P3-W4 next-action policy tests remain future-window work. | Add next-action policy-level tests in P3-W4 and bridge tests in P3-W5. |
...
| Application modules may keep accumulating policy decisions | Open | P3-W2 and P3-W3 reduced application policy logic; P3-W4 next-action and P3-W5 bridge tests still required. |
...
| Remaining policies not extracted | No | Yes | P3-W4 next-action policy and P3-W5 bridge hardening remain implementation windows. |
