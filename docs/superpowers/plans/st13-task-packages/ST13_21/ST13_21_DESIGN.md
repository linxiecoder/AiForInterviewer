...
- `docs/design/workbench-mvp/` 正式设计事实源和 W13-E5 / W13-E6 / W13-E7 文档。
...
- 前置依赖：`docs/design/workbench-mvp/` 正式设计事实源、W13-E5 readiness audit、W13-E6 第一批任务包草案、用户确认 `OQ-111=A / OQ-112=A / OQ-113=B`。
