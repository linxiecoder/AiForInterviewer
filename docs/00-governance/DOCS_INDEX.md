...
| F4 技术设计草案 | `docs/02-design/TECH_DESIGN.md` | AIFI-ARCH-001 当前产物；阶段 F4；状态 DRAFT；类型 active technical design draft；基于 `docs/01-product/PRD.md`、`docs/02-design/UX_SPEC.md` 和 `docs/02-design/UI_DESIGN_SYSTEM.md` 冻结技术架构边界；不替代后续 `API_SPEC.md`、`DATA_MODEL.md`、`PROMPT_SPEC.md` 或 `SECURITY_PRIVACY.md` |
...
| `docs/02-design/` | active | 当前仅 `UX_SPEC.md` 作为 F2 低保真设计输出生效；后续高保真和技术相关文档未创建前不得作为执行依据 |
