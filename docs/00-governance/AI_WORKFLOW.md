...
3. 与当前任务对应的唯一入口：
   - 阶段：`docs/03-implementation/DELIVERY_PLAN.md`
   - 任务：`docs/03-implementation/BACKLOG.md`
...
| 内容 | 写入位置 |
| --- | --- |
| 新任务 | `docs/03-implementation/BACKLOG.md` |
| 新阶段或里程碑 | `docs/03-implementation/DELIVERY_PLAN.md` |
