...
一期 MVP 已确认为工作台级范围，包含真实 LLM、登录 / 权限、服务端保存、历史 / 复盘、RAG / 知识库、多轮高阶面试、0-100 多维评分、复制 / Markdown 下载。历史前端原型只作为参考证据，不能作为正式一期 MVP 起点。
...
- `docs/design/workbench-mvp/` 当前设计输入和 W13-E5 / W13-E6 / W13-E7 文档。
...
- 前置依赖：`docs/design/workbench-mvp/` 当前设计输入、W13-E5 readiness audit、W13-E6 第一批任务包草案、用户确认 `OQ-111=A / OQ-112=A / OQ-113=B`。
...
- 允许：`docs/tasks/workbench-mvp/st13-task-packages/ST13_21/ST13_21_DESIGN.md`
- 允许：`docs/tasks/workbench-mvp/st13-task-packages/ST13_21/ST13_21_IMPLEMENTATION.md`
