...
import { StageStrip, type WorkflowStageStatus } from "./StageStrip.js";
...
export function LegacyMockPage() {
  ...
  return (
    <main className="app-shell legacy-mock-shell">
      <section className="workspace-header" aria-labelledby="legacy-page-title">
        <div>
          <p className="eyebrow">{appText.header.eyebrow}</p>
          <h1 id="legacy-page-title">旧 Mock 原型 / Legacy</h1>
          <p className="header-copy">{appText.header.copy}</p>
          <p className="header-copy">{appText.header.title}</p>
        </div>
        <div className="status-group" aria-label="旧原型状态">
      ...
      <section className="boundary-note" aria-label="旧原型边界">
