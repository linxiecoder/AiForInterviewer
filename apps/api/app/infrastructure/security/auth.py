...
def build_auth_runtime_from_env(*, cookie_path: str = "/api/v1") -> AuthRuntime:
    seed_enabled = _env.bool("API_AUTH_DEV_USER_ENABLED", _default_dev_seed_enabled())
    dev_user_identifier = _env.str("API_AUTH_DEV_USER_IDENTIFIER", "developer")
    dev_user_password = _env.optional("API_AUTH_DEV_USER_PASSWORD")
...
def _default_dev_seed_enabled() -> bool:
    return (_env.first_of("API_AUTH_ENV", "API_ENV") or "local").lower() in {"local", "test", "development", "dev"}
