...
def build_phase11_l5_agent_definitions() -> tuple[AgentDefinition, ...]:
    """Return P11-W3 L5 contract catalog agents without changing C1 behavior."""
...
def build_phase11_l5_skill_definitions() -> tuple[SkillDefinition, ...]:
    """Return P11-W3 L5 skills composed from C1, Orchestrator and product-slice agents."""
...
def build_phase11_l5_tool_definitions() -> tuple[ToolDefinition, ...]:
    """Return P11-W3 L5 tools composed from C1, Orchestrator and product-slice agents."""
