...
SOURCE_PRIORITY_POLICY_BY_PURPOSE: dict[str, dict[str, int]] = {
    "initial_plan": {
        ...
        "match_focus": 3,
        "resume_project": 4,
        "resume_project_contribution": 5,
        "resume_skill": 6,
        "job_responsibility": 7,
        "resume_work_experience": 8,
        "match_suggested_question": 9,
        "job_other_note": 10,
        "resume_summary": 11,
        "resume_education": 12,
        "turn_feedback": 13,
    ...
    "state_refresh": {
        ...
        "turn_answer": 8,
        "resume_skill": 9,
        "job_responsibility": 10,
        "resume_work_experience": 11,
        "match_suggested_question": 12,
        "job_other_note": 13,
        "resume_summary": 14,
        "asset_summary": 15,
        "weakness": 16,
...
SEMANTIC_RESUME_SOURCE_TYPES = frozenset(
    {"resume_project", "resume_project_contribution", "resume_skill", "resume_work_experience"}
)
